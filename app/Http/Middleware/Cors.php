...
class Cors
{
    ...
    public function handle($request, Closure $next)
    {
        return $next($request)
           ...
           ->header('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS, HEAD') // or specify `'GET, POST, PUT, DELETE'` etc as the second parameter if you want to restrict the methods that are allowed.
